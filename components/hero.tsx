        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">{t("hero.description")}</p>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl shadow-lg p-6 max-w-xs border border-gray-200 dark:border-gray-700 transition-all duration-500 hover:scale-105 hover:shadow-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-gray-100">{t("hero.statsProducts")}</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{t("hero.statsDescription")}</p>
                </div>
              </div>
            </div>
          </div>
