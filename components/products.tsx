    ...
    <section id="productos" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100">{t("products.title")}</h2>
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                {product.badge && <Badge className="absolute top-4 left-4 animate-pulse">{product.badge}</Badge>}
              ...
              <CardContent className="p-6">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold text-amber-600 animate-pulse">{product.price}</span>
                  </div>
