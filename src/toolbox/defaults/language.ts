export const TRANSLATIONS = {
  es: {
    ...
    'about.freshDailyDesc':
      'Todos nuestros productos se hornean frescos cada día para garantizar la mejor calidad.',
  ...
  en: {
    ...
    'about.madeWithLoveDesc':
      'Each product is crafted with passion and dedication by our master bakers.',
    'about.premiumQuality': 'Premium Quality',
    'about.premiumQualityDesc':
      'We use only the finest local ingredients and traditional baking techniques.',
    'about.familyTradition': 'Family Tradition',
    'about.familyTraditionDesc':
      'We are a family business with over 20 years of experience in the art of baking.',
    'about.freshDaily': 'Fresh Daily',
    'about.freshDailyDesc':
      'All our products are baked fresh every day to ensure the best quality.',
    ...
    'contact.description':
      "Have any questions or want to place a special order? We're here to help.",
    ...
    // Footer
    'footer.description':
      'Baking happiness since 2003. Fresh products, authentic flavors and special moments.',
  ...
  ca: {
    ...
    'about.madeWithLoveDesc':
      'Cada producte està elaborat amb passió i dedicació pels nostres mestres flequers.',
    'about.premiumQuality': 'Qualitat Premium',
    'about.premiumQualityDesc':
      'Utilitzem només els millors ingredients locals i tècniques tradicionals de fleca.',
    'about.familyTradition': 'Tradició Familiar',
    'about.familyTraditionDesc':
      "Som una empresa familiar amb més de 20 anys d'experiència en l'art de la fleca.",
    'about.freshDaily': 'Fresc Diàriament',
    'about.freshDailyDesc':
      'Tots els nostres productes es fornejen frescos cada dia per garantir la millor qualitat.',
    ...
    'contact.description':
      'Tens alguna pregunta o vols fer una comanda especial? Som aquí per ajudar-te.',
    ...
    // Footer
    'footer.description':
      'Fornejant felicitat des del 2003. Productes frescos, sabors autèntics i moments especials.',
